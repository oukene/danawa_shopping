            ...
            data_schema=vol.Schema(
                    {
                        ...
                        vol.Required(CONF_SORT_TYPE, default=SORT_TYPES_REVERSE[self._selected_option.get(CONF_SORT_TYPE, "saveDESC")]): selector.SelectSelector(selector.SelectSelectorConfig(options=list(SORT_TYPES.keys()), custom_value=False,
